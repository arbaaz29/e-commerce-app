<?php
    ...
    if(isset($_POST['update_product'])){
        ...
        if(empty($product_title) || empty($product_description) || empty($product_keywords) || empty($product_category_id) || empty($product_brand_id) || empty($product_image_one) || empty($product_image_two) || empty($product_image_three) || empty($product_price)){
            ...
            move_uploaded_file($product_image_one_tmp,"./admin/product_images/$product_image_one");
            move_uploaded_file($product_image_two_tmp,"./admin/product_images/$product_image_two");
            move_uploaded_file($product_image_three_tmp,"./admin/product_images/$product_image_three");
            // update query 
