...
if(isset($_POST['insert_product'])){
    ...
    if($product_title == '' || $product_description == '' || $product_keywords == '' || $product_category == '' || $product_brand == '' || empty($product_price) || empty($product_image_one) || empty($product_image_two) || empty($product_image_three)){
        ...
        //move folders
        move_uploaded_file($temp_image_one,"https://d16mupo63ti3ee.cloudfront.netadmin/product_images/$product_image_one");
        move_uploaded_file($temp_image_two,"https://d16mupo63ti3ee.cloudfront.netadmin/product_images/$product_image_two");
        move_uploaded_file($temp_image_three,"https://d16mupo63ti3ee.cloudfront.netadmin/product_images/$product_image_three");
        //insert query in db
